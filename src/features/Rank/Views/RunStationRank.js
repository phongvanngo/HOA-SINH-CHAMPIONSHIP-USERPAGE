...
import { fetchRankRunStationRequest } from './../RankSlice';
...
export default function SingleRank() {
    ...
    const singleRank = useSelector(state => state.rank.runStationRank);
    ...
    const handleSearch = (e) => {
        ...
        setSearchUserRank({
            ...
            typingTimeout: setTimeout(() => {
                dispatch(fetchRankRunStationRequest({ reloadAll: true, searchValue: e.target.value }));
            }, 500)
        })
    }

    useEffect(() => {
        dispatch(fetchRankRunStationRequest({ reloadAll: true, searchValue: "" }));
    }, [dispatch])

    const handleSeeMore = () => {
        dispatch(fetchRankRunStationRequest({ reloadAll: false, searchValue: "" }));
    }
                ...
                <div className="lboard_tabs">
                    <div className="tabs">
                        <div className="header">
                            <div className="title">Bảng chạy trạm</div>
